...
public class LoginView extends javax.swing.JFrame {
    ...
    public LoginView() {
        initComponents();
        setSize(930, 415);  // Mantener el tamaño de la ventana
        setResizable(false);  // No es posible dimensionarla
        setTitle("Ingresar al sistema");  // Título a la ventana
        setLocationRelativeTo(null);
        this.repaint();  // Para mostrar los cambios
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(btn_enter, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 300, 210, 35));
