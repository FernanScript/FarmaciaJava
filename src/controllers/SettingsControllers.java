...
public class SettingsControllers implements MouseListener{
    ...
    public void mouseEntered(MouseEvent e) {
        if(e.getSource() == views.jLabelProducts){
            views.jPanelProducts.setBackground(new Color(10,26,36));
        } else if(e.getSource() == views.jLabelPurchases){
            views.jPanelPurchases.setBackground(new Color(10,26,36));
        } else if(e.getSource() == views.jLabelCustomers){
            views.jPanelCustomers.setBackground(new Color(10,26,36));
        } else if(e.getSource() == views.jLabelEmployees){
            views.jPanelEmployees.setBackground(new Color(10,26,36));
        } else if(e.getSource() == views.jLabelSuppliers){
            views.jPanelSuppliers.setBackground(new Color(10,26,36));
        } else if(e.getSource() == views.jLabelCategories){
            views.jPanelCategories.setBackground(new Color(10,26,36));
        } else if(e.getSource() == views.jLabelReports){
            views.jPanelReports.setBackground(new Color(10,26,36));
        } else if(e.getSource() == views.jLabelSettings){
            views.jPanelSettings.setBackground(new Color(10,26,36));
        }
    }
